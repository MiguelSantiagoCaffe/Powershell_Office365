...
#region ***Parameters***
$SiteURL="https://ipaeedupe.sharepoint.com/sites/FINANZAS-TESORERIA"
$ReportFile="D:\reportesharepoint\SitePermissionFINANZAS1.csv"
#endregion
...
#Read more: https://www.sharepointdiary.com/2019/09/sharepoint-online-user-permissions-audit-report-using-pnp-powershell.html#ixzz8H3fRSTv5